...
for i in range(30):
    ...
    if id(training_yr) not in ids:
        ...
        features = ['Date','thermD', 'delT', 'U','AirP', 'Hum', 'AirT', 'SWR', 'CC', 'Prec', 'MLD', 'W', 'Inva_spe',
               'days from iceoff date_-2', 'days from iceoff date_-1','days from iceoff date_0', 'days from iceoff date_1',
               'days from iceoff date_2', 'days from iceoff date_3', 'Ice_d_long','Ice_d_middle', 'Ice_d_no_ice_d', 'Ice_d_short']
